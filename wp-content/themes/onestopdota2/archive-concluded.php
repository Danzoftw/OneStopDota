...
<section class="new-banner-section py-5 bg-cover h-m95vh position-relative d-flex align-items-center" style="background-image: url('<?php the_field('page_banner', 191); ?>')">
  <div class="theme bg-mid-black-opa position-absolute w-100 h-100 top">
  </div>
  <div class="container">
    <div class="row">
      <div class="title-holder col-12 mb-4">
        <h1 class="theme color-white large-title font-Apercu-pro"><?php the_field('page_title', 191); ?></h1>
      </div>
      <div class="content-holder mb-4 pr-lg-5 col-12">
        <?php the_field('page_content', 191); ?>
      </div>
    </div>
  </div>
</section>
